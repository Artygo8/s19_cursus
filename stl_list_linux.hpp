...
_GLIBCXX_BEGIN_NAMESPACE_CONTAINER
  ...
  //    _   ___ _____ _   _  _   _      _  _  ___  ___  ___ 
  //   /_\ / __|_   _| | | |/_\ | |    | \| |/ _ \|   \| __|
  //  / _ \ (__  | | | |_| / _ \| |__  | .` | (_) | |) | _| 
  // /_/ \_\___| |_|  \___/_/ \_\____| |_|\_|\___/|___/|___|
  //                                                        
  ...
  */
  ...
  //  ___ _____ ___ ___    _ _____ ___  ___ 
  ...
  */
  ...
  //   ___ ___  _  _ ___ _____   ___ _____ ___ ___    _ _____ ___  ___ 
  //  / __/ _ \| \| / __|_   _| |_ _|_   _| __| _ \  /_\_   _/ _ \| _ \
  // | (_| (_) | .` \__ \ | |    | |  | | | _||   / / _ \| || (_) |   /
  //  \___\___/|_|\_|___/ |_|   |___| |_| |___|_|_\/_/ \_\_| \___/|_|_\
  //                                                                   
  ...
  template<typename _Tp>
    struct _List_const_iterator
    {
      ...
      explicit _List_const_iterator(const __detail::_List_node_base* __x) _GLIBCXX_NOEXCEPT
      : _M_node(__x) {}
  ...
  // | |__ | |\__ \ | |   | _ \/ _ \\__ \ _| 
  // |____|___|___/ |_|   |___/_/ \_\___/___|
  //                                         
...
_GLIBCXX_BEGIN_NAMESPACE_CXX11
  ...
  template<typename _Tp, typename _Alloc>
    ...
    protected:
      ...
      // _    ___ ___ _____   ___ __  __ ___ _    
      //| |  |_ _/ __|_   _| |_ _|  \/  | _ \ |   
      //| |__ | |\__ \ | |    | || |\/| |  _/ |__ 
      //|____|___|___/ |_|   |___|_|  |_|_| |____|
      //                                          
	...
	_List_impl() _GLIBCXX_NOEXCEPT_IF(is_nothrow_default_constructible<_Node_alloc_type>::value)
	: _Node_alloc_type() {}
...
# endif
      ...
      void _M_put_node(typename _Node_alloc_traits::pointer __p) _GLIBCXX_NOEXCEPT
      {
  ...
  */
  ...
  template<typename _Tp, typename _Alloc = std::allocator<_Tp> >
    ...
    public:
       ...
       */
      list(const list& __x)
      : _Base(_Node_alloc_traits::_S_select_on_copy(__x._M_get_Node_allocator()))
      {
	...
	void insert(iterator __position, _InputIterator __first, _InputIterator __last)
	{
       ...
       */
      void swap(list& __x) _GLIBCXX_NOEXCEPT
      {
...
/**
  ...
  */
  ...
  /// See std::list::swap().
  template<typename _Tp, typename _Alloc>
    inline void swap(list<_Tp, _Alloc>& __x, list<_Tp, _Alloc>& __y) _GLIBCXX_NOEXCEPT_IF(noexcept(__x.swap(__y)))
    {
          __x.swap(__y);
    }
...
_GLIBCXX_END_NAMESPACE_CONTAINER
  ...
  template<typename _Tp>
    inline ptrdiff_t __distance(_GLIBCXX_STD_C::_List_iterator<_Tp> __first, _GLIBCXX_STD_C::_List_iterator<_Tp> __last, input_iterator_tag __tag)
    {
  ...
  template<typename _Tp>
    inline ptrdiff_t __distance(_GLIBCXX_STD_C::_List_const_iterator<_Tp> __first, _GLIBCXX_STD_C::_List_const_iterator<_Tp> __last, input_iterator_tag)
    {
